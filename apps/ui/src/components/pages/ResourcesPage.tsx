    ...
    <PageShell title="Zasoby" subtitle="Zarządzanie zasobami budowlanymi" actions={actions}>
      <motion.div className="flex flex-col gap-6" variants={container} initial="hidden" animate="show">
          ...
          <div className="flex gap-1 p-1 rounded-token-lg bg-earth-900 border border-earth-800/60">
            {([['all', 'Wszystkie'], ['person', 'Pracownicy'], ['equipment', 'Sprzęt']] as const).map(([key, label]) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-token text-xs font-medium transition-all ${
        ...
        <motion.div variants={item} className="flex gap-4 min-h-[480px]">
          {/* Resource List */}
          <div className="w-[380px] shrink-0 card rounded-token-lg overflow-y-auto shadow-token-sm">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 rounded-token-lg bg-earth-800 flex items-center justify-center border border-earth-700/40">
                        {r.type === 'person'
          ...
          <div className="flex-1 card rounded-token-lg p-6 shadow-token-sm">
            {selected ? (
              <div className="space-y-5">
                <div className="flex items-center gap-4">
                  <div className="w-14 h-14 rounded-token-xl bg-earth-800 flex items-center justify-center border border-earth-700/40">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-3 rounded-token-lg bg-earth-900/60 border border-earth-800/40">
                  ...
                  <div className="grid grid-cols-7 gap-1">
                    ...
                    {Array.from({ length: 31 }, (_, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`text-center text-xs py-2 rounded-token ${
